...
GRANT ALL PRIVILEGES ON dbtest.* TO nci@localhost IDENTIFIED BY 'password';
use dbtest;
...
insert into custdetails (name,address) values ('Brett McBain','Sweetwater Farm'); select * from custdetails;
FINISH
#
cd /tmp
rm -rf $SANDBOX
